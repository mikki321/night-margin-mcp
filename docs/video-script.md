...
**[SCREEN: Terminal. Type and run `claude mcp add margin -- npx -y night-margin-mcp`. A visible clock/stopwatch in frame. Cut (or speed up) to Claude with the eight margin tools listed. This beat can be a pre-recorded clip.]**
